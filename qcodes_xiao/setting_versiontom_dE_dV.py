...
from manipulation_library import Ramsey, Finding_Resonance, Rabi, CRot, AllXY, Ramsey_all, AllXY_all, CPhase_Calibrate, Charge_Noise, DCZ, Sychpulses1, Sychpulses2, Rabi_all, Wait, MeasureTminus, Ramsey_00_11_basis, RB, Rabi_detuning, RB_all,RB_Marcus, Ramsey_withnoise
...
T_shift =30*0.5*-0.0032
Lp_shift = 30*0.5*0.0064

T_shift2 =30*0.5*0.0030
Lp_shift2 = 30*0.5*0.000
#
T_shift =30*0.5*-0.003
Lp_shift = 30*0.5*0.000

T_shift2 =30*0.5*-0.000
Lp_shift2 = 30*0.5*0.00


init_cfg = {
        'step1' : set_step(time = 1.0e-3, qubits = qubits, voltages = [T_factor*30*0.5*0.004+T_shift, LP_factor*30*0.5*-0.001+Lp_shift]),
        'step2' : set_step(time = 1.0e-3, qubits = qubits, voltages = [T_factor*30*0.5*-0.004+T_shift, LP_factor*30*0.5*0+Lp_shift]),
        'step3' : set_step(time = 0.1e-3, qubits = qubits, voltages = [T_factor*30*0.5*-0.0142+T_shift2, LP_factor*30*0.5*0+Lp_shift2]),
        'step4' : set_step(time = 2e-3, qubits = qubits, voltages = [T_factor*30*0.5*-0.000+T_shift, LP_factor*30*0.5*0+Lp_shift]),
        'step5' : set_step(time = 0.1e-3, qubits = qubits, voltages = [T_factor*30*0.5*0.002+T_shift, LP_factor*30*0.5*0.000+Lp_shift]),
#        'step6' : set_step(time = 0.1e-3, qubits = qubits, voltages = [T_factor*30*0.5*0.00, LP_factor*30*0.5*0.01]),
        }

manip_cfg = {
        'step1' : set_manip(time = 1.5e-6, qubits = qubits, voltages = [T_factor*30*0.5*-0.007,LP_factor*30*0.5*0.016],)
        }

read_cfg = {
        'step1' : set_step(time = 0.302e-3, qubits = qubits, voltages = [T_factor*30*0.5*-0.000+T_shift, LP_factor*30*0.5*0+Lp_shift]),
        'step2' : set_step(time = 0.05e-3, qubits = qubits, voltages = [T_factor*30*0.5*-0.000+T_shift, LP_factor*30*0.5*0+Lp_shift]),
        'step3' : set_step(time = 0.688e-3, qubits = qubits, voltages = [T_factor*30*0.5*-0.000+T_shift, LP_factor*30*0.5*0+Lp_shift]),
        }
init2_cfg = {
        'step1' : set_step(time = 1e-3, qubits = qubits, voltages = [T_factor*30*0.5*-0.000+T_shift, LP_factor*30*0.5*0+Lp_shift]),
        'step2' : set_step(time = 0.1e-3, qubits = qubits, voltages = [T_factor*30*0.5*0.002+T_shift, LP_factor*30*0.5*0.000+Lp_shift]),
        }
manip2_cfg = {
        'step1' : set_manip(time = 1.5e-6, qubits = qubits, voltages = [T_factor*30*0.5*-0.007+T_shift2,LP_factor*30*0.5*0.016+Lp_shift2],)
        }
read2_cfg = {
        'step1' : set_step(time = 0.302e-3, qubits = qubits, voltages = [T_factor*30*0.5*-0.000+T_shift, LP_factor*30*0.5*0+Lp_shift]),
        'step2' : set_step(time = 0.05e-3, qubits = qubits, voltages = [T_factor*30*0.5*-0.000+T_shift, LP_factor*30*0.5*0+Lp_shift]),
...
init_cfg_T1 = {
        ...
        'step3' : set_step(time = 0.1e-3, qubits = qubits, voltages = [T_shift+30*0.5*-0.012, 30*0.5*0]),
...
crot = CRot(name = 'CRot', pulsar = pulsar, amplitude = 30*0.5*-0.0266*T_factor, amplitudepi = 1.2, 
            frequency_shift = 0.0555e9, duration_time = 261e-9)
...
experiment.add_X_parameter('CRot_Scan', parameter = 'frequency_shift', sweep_array = sweep_array(0.04e9, 0.06e9, 31), element = 'CRot')
...
experiment.add_Y_parameter('CRot_Scan', parameter = Count, sweep_array = sweep_array(1, 3, 3),)
...
experiment.add_X_parameter('CN', parameter = 'waiting_time', sweep_array = sweep_array(0, 0.6e-6, 41), element = 'Charge_Noise')

experiment.add_measurement('CN2', ['Charge_Noise_2', 'CRot'], [charge_noise_bob2, crot], sequence21_cfg, sequence21_cfg_type)
experiment.add_X_parameter('CN2', parameter = 'waiting_time', sweep_array = sweep_array(0, 0.6e-6, 41), element = 'Charge_Noise_2')
...
cphase = CPhase_Calibrate(name = 'CPhase', pulsar = pulsar, Pi_amplitude = 0, 
                          detuning_amplitude = 30*0.5*-0.0267, detuning_amplitude2 = 30*0.5*0.02,
                          detuning_time = 80e-9, phase = 0, off_resonance_amplitude = 1.2, control_qubit = 'qubit_2')
...
dcz = DCZ(name = 'DCZ', pulsar = pulsar, Pi_amplitude = 0, detuning_amplitude = 30*0.5*-0.0273, detuning_amplitude2 = 30*0.5*0.02, 
          detuning_time = 80e-9, phase = 0, off_resonance_amplitude = 1.2, control_qubit = 'qubit_2')

dcz2 = DCZ(name = 'DCZ2', pulsar = pulsar, Pi_amplitude = 1, detuning_amplitude = 30*0.5*-0.0273, detuning_amplitude2 = 30*0.5*0.02, 
           detuning_time = 80e-9, phase = 0, off_resonance_amplitude = 1.2, control_qubit = 'qubit_2')
...
experiment.add_Y_parameter('Rabi_Scan', parameter = Count, sweep_array = sweep_array(0, 5, 5))
...
ramsey_withnoise = Ramsey_withnoise(name = 'Ramsey_withnoise', pulsar = pulsar, qubit = 'qubit_1', off_resonance_amplitude = 1.2, amplitude = 1, 
                      duration_time = 125e-9, waiting_time = 300e-9,detune_q1= True, sigma1 =30*0.5*0.0000 , sigma2=30*0.5*0.000, sigma3 =0.0e6 , sigma4=0.3e6)


experiment.add_measurement('Ramsey_Scan', ['ramsey_withnoise','CRot'], [ramsey_withnoise, crot], sequence_cfg, sequence_cfg_type)
#experiment.add_X_parameter('Ramsey_Scan', parameter = 'frequency_shift', sweep_array = sweep_array(-0.005e9, 0.005e9, 31), element = 'Ramsey12')
experiment.add_X_parameter('Ramsey_Scan', parameter = 'waiting_time', sweep_array = sweep_array(0, 1e-6, 31), element = 'ramsey_withnoise')
